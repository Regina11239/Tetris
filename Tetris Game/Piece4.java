...
public class Piece4 extends TetrisPiece
{
	Matrix m0, m1, m2, m3;
	...
	public void alignColors()
	{
		...
		m2.getSquare(2,0).setColor(m0.getSquare(0,1).getColor());
		...
		m3.getSquare(0,0).setColor(m0.getSquare(0,1).getColor());
